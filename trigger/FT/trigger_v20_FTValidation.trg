...
VTP_GT_TRGBIT  0   1  63  1  1  0  # SSP STRG0, SECTOR 1-6

# FTOFxPCU
VTP_GT_TRGBIT  1   1   1  1  1  0  # SSP STRG0, SECTOR 1
VTP_GT_TRGBIT  2   1   2  1  1  0  # SSP STRG0, SECTOR 2
VTP_GT_TRGBIT  3   1   4  1  1  0  # SSP STRG0, SECTOR 3
VTP_GT_TRGBIT  4   1   8  1  1  0  # SSP STRG0, SECTOR 4
VTP_GT_TRGBIT  5   1  16  1  1  0  # SSP STRG0, SECTOR 5
VTP_GT_TRGBIT  6   1  32  1  1  0  # SSP STRG0, SECTOR 6

# FTOFxPCUx(PCAL>15MeV)
VTP_GT_TRGBIT  7   2   1  1  1  0  # SSP STRG1, SECTOR 1
VTP_GT_TRGBIT  8   2   2  1  1  0  # SSP STRG1, SECTOR 2
VTP_GT_TRGBIT  9   2   4  1  1  0  # SSP STRG1, SECTOR 3
VTP_GT_TRGBIT  10  2   8  1  1  0  # SSP STRG1, SECTOR 4
VTP_GT_TRGBIT  11  2  16  1  1  0  # SSP STRG1, SECTOR 5
VTP_GT_TRGBIT  12  2  32  1  1  0  # SSP STRG1, SECTOR 6
...
VTP_GT_TRGBIT  19   8   1  1  1  0  # SSP STRG3, SECTOR 1
VTP_GT_TRGBIT  20   8   2  1  1  0  # SSP STRG3, SECTOR 2
VTP_GT_TRGBIT  21   8   4  1  1  0  # SSP STRG3, SECTOR 3
VTP_GT_TRGBIT  22   8   8  1  1  0  # SSP STRG3, SECTOR 4
VTP_GT_TRGBIT  23   8  16  1  1  0  # SSP STRG3, SECTOR 5
VTP_GT_TRGBIT  24   8  32  1  1  0  # SSP STRG3, SECTOR 6


#BIT 25-28 for central, not yet implemented

VTP_GT_TRGBIT  25  8   63  1  1  0  # SSP STRG3, SECTOR 1-6
VTP_GT_TRGBIT  26  8   63  1  1  0  # SSP STRG3, SECTOR 1-6
VTP_GT_TRGBIT  27  8   63  1  1  0  # SSP STRG3, SECTOR 1-6
VTP_GT_TRGBIT  28  8   63  1  1  0  # SSP STRG3, SECTOR 1-6

#BIT 29: FTCal(300-4000MeV)xFTHodo(2L) 
VTP_GT_TRGBIT  29  0  63  1  0  1    # SSP CTRG0

#BIT 30: FTCal(100-8000MeV)
VTP_GT_TRGBIT  30  0  63  1  0  4    # SSP CTRG2
...
# TS GTP trigger mask
#
#Enable as trigger source only bit 29 - FTCal(300..4000)xFTHodo(2L)
#TS_GTP_INPUT_MASK 0xFFFFFFFF
TS_GTP_INPUT_MASK 0x20000000
...
#BITS 25..28: central
#BIT 29:      FTCal(300-4000)xFTHodo(2L)
#BIT 30:      FTCal(100-8000)
#BIT 31:      Pulser

#BIT 29 (here is 30, see comment before)
#This has to be properly fixed
TS_GTP_PRESCALE  30 0  

#BIT 30 (here is 31, see comment before)
TS_GTP_PRESCALE 31 0
