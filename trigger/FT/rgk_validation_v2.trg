...
########################
# Central Trigger bit 2    CTRG2:   FT(200-4000)
########################
SSP_GTC_CTRG                       2
SSP_GTC_CTRG_EN                    1
...
# FT X DC X FTOFPCU X PCAL > 10 MeV X CTOF (new, segments)
VTP_GT_TRGBIT  0   8  63  1  1  8  0 # SSP STRG3, SECTOR 1-6, CTRG3
...
#CTOF-new * CND
VTP_GT_TRGBIT  28  64  63  1  1  0  0 # SSP STRG6, SECTOR 1-6

#BIT 29: FT(200-4000)MeV x DC(segments) x FTOFPCU x PCAL>10MeV (2 Sectors)
VTP_GT_TRGBIT  29  2   63  2  1  1  0 # SSP STRG1, SECTOR 1-6, CTRG0

#BIT 30: FT(200-4000)MeV x DC(segments) x FTOFPCU x PCAL>10MeV x CTOF(new)*CND 
