...
#################
#                       Electron NO DC  
# Sector Trigger bit 0  STRG0: HTCC x (PCAL+ECAL)>200MeV x PCAL>60MeV
#   
#################
SSP_GT_STRG                           0
SSP_GT_STRG_EN                        1
...
#
# Sector Trigger bit 3 STRG3 (DCROADxPCALU) x HTCC x (PCAL+ECAL)>200MeV x PCAL>60MeV
# 
##################
SSP_GT_STRG                           3
SSP_GT_STRG_EN                        1
...
#################
#                Hadron Trigger w/DC ROADS (NOTE: FTOFPCU_WIDTH=0, so don't use with FT)
#
# Sector Trigger bit 6 STRG6: DCROAD x FTOFPCU=+/-3 x PCAL=(10)MeV
#
# 
#################
SSP_GT_STRG                           6
...
########################
# Central Trigger bit 3    CTRG3:  FT(200-4000)xHD(2)xCTOF 
########################
SSP_GTC_CTRG                       3
SSP_GTC_CTRG_EN                    1
...
# Hadron trigger: Two Sectors (any) w/DC ROADS
VTP_GT_TRGBIT  14   64 63  2               17 0  6     0  #  STRG6, any two SECTOR (+68ns coincidence)
VTP_GT_TRGBIT  15   64 63  2                8 0  6     0  #  STRG6, any two SECTOR (+32ns coincidence)
VTP_GT_TRGBIT  16   64 63  2                4 0  6     0  #  STRG6, any two SECTOR (+16ns coincidence)

# Hadron trigger: Two Sectors (any) w/DC SEGS
VTP_GT_TRGBIT  17   16 63  2               17 0  6     0  #  STRG4, any two SECTOR (+68ns coincidence)
VTP_GT_TRGBIT  18   16 63  2                8 0  6     0  #  STRG4, any two SECTOR (+32ns coincidence)
VTP_GT_TRGBIT  19   16 63  2                4 0  6     0  #  STRG4, any two SECTOR (+16ns coincidence)

# FT(200 - 4000) MeV x DC x FTOFPCU x PCAL>10MeV x CTOF
VTP_GT_TRGBIT  20  16  63  1               1  8  0    20  # SSP STRG4, SECTOR 1-6, CTRG3

# FT(200-4000)MeV x DC x FTOFPCU x PCAL>10MeV (2 Sectors)
VTP_GT_TRGBIT  21  16  63  2               1  1  0     1  # SSP STRG4, SECTOR 1-6, CTRG0

# 2 FT clusters (500-8500)MeV
VTP_GT_TRGBIT  22   0  63  1               0  2  0    20  #  CTRG1 

# FT(100-8000)MeV without hodoscope
VTP_GT_TRGBIT  23   0  63  1               0  4  0 15000  #  CTRG2

# Electron, Individual Sectors HTCC x (ECAL+PCAL Clusters), no DC
VTP_GT_TRGBIT  24   1   1  1                1  0  0    0  #  STRG0, SECTOR 1
VTP_GT_TRGBIT  25   1   2  1                1  0  0    0  #  STRG0, SECTOR 2
VTP_GT_TRGBIT  26   1   4  1                1  0  0    0  #  STRG0, SECTOR 3
VTP_GT_TRGBIT  27   1   8  1                1  0  0    0  #  STRG0, SECTOR 4
VTP_GT_TRGBIT  28   1  16  1                1  0  0    0  #  STRG0, SECTOR 5
VTP_GT_TRGBIT  29   1  32  1                1  0  0    0  #  STRG0, SECTOR 6
