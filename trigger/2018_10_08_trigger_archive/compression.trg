...
VTP_CRATE adcpcal1vtp
  include trigger/VTP/pcalvtp_disable.cnf
...
#
#   DC x HTCC x (PCAL+ECAL)>250MeV x PCAL>60MeV x ECAL>10MeV
########################
SSP_GT_STRG                           0
SSP_GT_STRG_EN                        1
...
# PCAL cluster trigger logic
SSP_GT_STRG_PCAL_CLUSTER_EMIN_EN      1
SSP_GT_STRG_PCAL_CLUSTER_EMIN      2500
SSP_GT_STRG_PCAL_CLUSTER_WIDTH       96
...
#
#   HTCC x (PCAL+ECAL)>250MeV x PCAL>60MeV x ECAL>10MeV
########################
SSP_GT_STRG                           5
SSP_GT_STRG_EN                        1
...
# FTOFPCU, Individual Sectors (for tagging/efficiency studies)
VTP_GT_TRGBIT 13 128   1  1  1  0  # SSP STRG7, SECTOR 1
VTP_GT_TRGBIT 14 128   2  1  1  0  # SSP STRG7, SECTOR 2
VTP_GT_TRGBIT 15 128   4  1  1  0  # SSP STRG7, SECTOR 3
VTP_GT_TRGBIT 16 128   8  1  1  0  # SSP STRG7, SECTOR 4
VTP_GT_TRGBIT 17 128  16  1  1  0  # SSP STRG7, SECTOR 5
VTP_GT_TRGBIT 18 128  32  1  1  0  # SSP STRG7, SECTOR 6


# FTOFPCUxPCAL>15 MeV All sectors
VTP_GT_TRGBIT  9  64  63  1  1  0  # SSP STRG7, SECTOR 1-6


# FTOFPCUxPCAL>15 MeV, Individual Sectors (for tagging/efficiency studies)
VTP_GT_TRGBIT 19  64   1  1  1  0  # SSP STRG7, SECTOR 1
VTP_GT_TRGBIT 20  64   2  1  1  0  # SSP STRG7, SECTOR 2
VTP_GT_TRGBIT 21  64   4  1  1  0  # SSP STRG7, SECTOR 3
VTP_GT_TRGBIT 22  64   8  1  1  0  # SSP STRG7, SECTOR 4
VTP_GT_TRGBIT 23  64  16  1  1  0  # SSP STRG7, SECTOR 5
VTP_GT_TRGBIT 24  64  32  1  1  0  # SSP STRG7, SECTOR 6


# FTOFPCUxPCAL>15 MeVxDC All sectors
VTP_GT_TRGBIT  10  4  63  1  1  0  # SSP STRG7, SECTOR 1-6


# FTOFPCUxPCAL>15 MeV x DC, Individual Sectors (for tagging/efficiency studies)
VTP_GT_TRGBIT 25  4   1  1  1  0  # SSP STRG7, SECTOR 1
VTP_GT_TRGBIT 26  4   2  1  1  0  # SSP STRG7, SECTOR 2
VTP_GT_TRGBIT 27  4   4  1  1  0  # SSP STRG7, SECTOR 3
VTP_GT_TRGBIT 28  4   8  1  1  0  # SSP STRG7, SECTOR 4
VTP_GT_TRGBIT 29  4  16  1  1  0  # SSP STRG7, SECTOR 5
VTP_GT_TRGBIT 30  4  32  1  1  0  # SSP STRG7, SECTOR 6


#########################################################################
#old triggers

# FTOF x PCAL>10MeV (3 Sectors)
##VTP_GT_TRGBIT  9   4  63  3  1  0  # SSP STRG2, SECTOR 1-6 (ANY 3)

# FTOF x PCAL>10MeV x ECAL>10MeV (3 Sectors)
##VTP_GT_TRGBIT 10   8  63  3  1  0  # SSP STRG3, SECTOR 1-6 (ANY 3)

# FTOF x PCAL>10MeV x CTOF
##VTP_GT_TRGBIT 11  16  63  1  1  0  # SSP STRG4, SECTOR 1-6

# Electron, sector 1 with DC
##VTP_GT_TRGBIT 12  96   1  1  1  0  # SSP STRG5|STRG6, SECTOR 1

# Electron, sector 2 with DC
##VTP_GT_TRGBIT 13  96   2  1  1  0  # SSP STRG5|STRG6, SECTOR 2
...
# Electron sector 3 with DC
##VTP_GT_TRGBIT 23  96   4  1  1  0  # SSP STRG5|STRG6, SECTOR 3

# Electron sector 4 with DC
##VTP_GT_TRGBIT 24  96   8  1  1  0  # SSP STRG5|STRG6, SECTOR 4

# FT with hodoscope
##VTP_GT_TRGBIT 28   0  63  1  0  1 # SSP CTRG0 (FT>500MeV)
...
#   TriggerBit 14  DC x FTOFPCU x PCAL>15MeV, S1
TS_GTP_PRESCALE 15 15
#   TriggerBit 15  DC x FTOFPCU x PCAL>15MeV, S2
TS_GTP_PRESCALE 16  15
#   TriggerBit 16  DC x FTOFPCU x PCAL>15MeV, S3
TS_GTP_PRESCALE 17  15
#   TriggerBit 17  DC x FTOFPCU x PCAL>15MeV, S4
TS_GTP_PRESCALE 18  15
#   TriggerBit 18  DC x FTOFPCU x PCAL>15MeV, S5
TS_GTP_PRESCALE 19  15
#   TriggerBit 19  DC x FTOFPCU x PCAL>15MeV, S6
...
#   TriggerBit 9 [FTOFxPCAL]^3
TS_GTP_PRESCALE 10  15
#   TriggerBit 10 [FTOFxPCALxCTOF]^3
TS_GTP_PRESCALE 11  15
#   TriggerBit 11 FTOFxPCALxCTOF
TS_GTP_PRESCALE 12 15
#   TriggerBit 12 Sector1xDC
TS_GTP_PRESCALE 13 15
#   TriggerBit 13 Sector2xDC
TS_GTP_PRESCALE 23  15
#   TriggerBit 23 Sector3xDC
TS_GTP_PRESCALE 24  15
#   TriggerBit 28 FT(300)xHODO
TS_GTP_PRESCALE 29 15
#   TriggerBit 29 Sector6xDC
TS_GTP_PRESCALE 30 15
#   TriggerBit 30 FT(250)xHODO
