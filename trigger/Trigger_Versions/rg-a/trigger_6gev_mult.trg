...
#
#   DC x HTCC x (PCAL+ECAL)>150MeV x PCAL>60MeV x ECAL>10MeV
########################
SSP_GT_STRG                           0
SSP_GT_STRG_EN                        1
...
# PCAL cluster trigger logic
SSP_GT_STRG_PCAL_CLUSTER_EMIN_EN      1
SSP_GT_STRG_PCAL_CLUSTER_EMIN      1500
SSP_GT_STRG_PCAL_CLUSTER_WIDTH       96
...
#
#   HTCC x (PCAL+ECAL)>150MeV x PCAL>60MeV x ECAL>10MeV
########################
SSP_GT_STRG                           5
SSP_GT_STRG_EN                        1
...
########################
# Central Trigger bit 0    FT(300-8500) 1 cluster 
########################
...
SSP_GTC_CTRG_FT_CLUSTER_MULT_MIN            1
...
########################
# Central Trigger bit 1     FT(300-8500) 2 clusters 
########################
...
########################
# Central Trigger bit 2      FT(300-8500)xHD(2) 2 clusters 
########################
...
SSP_GTC_CTRG_FT_CLUSTER_EMIN             3000
SSP_GTC_CTRG_FT_CLUSTER_EMAX             8500
SSP_GTC_CTRG_FT_CLUSTER_HODO_NMIN           0
SSP_GTC_CTRG_FT_CLUSTER_NMIN                1
SSP_GTC_CTRG_FT_CLUSTER_WIDTH               0
...
# 8500MeV>FT>300MeV 1 cluster in FT
VTP_GT_TRGBIT 24  0  63  1  0  1  # CTRG0

# 8500MeV>FT>300MeV 2 clusters in FT
VTP_GT_TRGBIT 25  0  63  1  0  2  # CTRG1

# 8000MeV>FT>100MeV with hodoscope
VTP_GT_TRGBIT 26  0  63  1  0  4  # CTRG2 

# 8000MeV>FT>100MeV without hodoscope
VTP_GT_TRGBIT 27  0  63  1  0  8  # CTRG3
...
# Helicity and Faraday Cup
3TS_FP_INPUT_MASK 0x00001080
...
# TriggerBits 7 Electron no DC 
TS_GTP_PRESCALE  8 15

# TriggerBits 8 PCALxECAL 
...
#####     FT TRIGGERS    ####
#
#   TriggerBit 24 FTxHDxFTOFxPCALxCTOF
