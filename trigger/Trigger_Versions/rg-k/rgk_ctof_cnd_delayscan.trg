...
SSP_GTC_CNDCTOF_CND_WIDTH    64
SSP_GTC_CNDCTOF_CTOF_WIDTH   64
...
#
#   FTOFxPCUx(PCAL>10MeV) x(DC) - old style DC, only segments
########################
SSP_GT_STRG                           1
SSP_GT_STRG_EN                        1
...
#
#   (FTOFxPCU)x(PCAL>10MeV)x(DC-old) x CTOF (new with clustering) x CND
...
#BEN: add new CTOF here please
# CTOF logic
#SSP_GT_STRG_CTOF_EN                   1
#SSP_GT_STRG_CTOF_WIDTH               64
#SSP_GT_STRG_CTOF_MASK              0xFF
#
#BEN: add CND here please

# CNDxCTOF Geometry Matching
SSP_GT_STRG_CNDCTOF_EN                1
SSP_GT_STRG_CNDCTOF_WIDTH            64
SSP_GT_STRG_CNDCTOF_MATCH_MASK        2

# SSP_GT_STRG_CNDCTOF_MATCH_MASK   N
# N: 1 = +/-0 CTOF strip tolerance
#    2 = +/-1 CTOF strip tolerance
#    4 = +/-2 CTOF strip tolerance
#    8 = +/-3 CTOF strip tolerance
#   16 = +/-4 CTOF strip tolerance
#   32 = +/-5 CTOF strip tolerance
...
#
#  (FTOFxPCU)x(PCAL>10MeV)x(DC-old) x CTOF (new with clustering) 
########################
SSP_GT_STRG                           3
SSP_GT_STRG_EN                        1
...
########################
# Central Trigger bit 0    CTRG0:  FT(1800-6600)xHD(2)
########################
SSP_GTC_CTRG 0

SSP_GTC_CTRG_EN                    1
SSP_GTC_CTRG_FT_CLUSTER_EN         1
SSP_GTC_CTRG_FT_CLUSTER_EMIN       1800
SSP_GTC_CTRG_FT_CLUSTER_EMAX       6600
...
########################
# Central Trigger bit 2    CTRG2:   FT(1800-6600)
########################
SSP_GTC_CTRG                       2
SSP_GTC_CTRG_EN                    1
...
########################
# Central Trigger bit 3    CTRG3:  FT(300-8500)
########################
SSP_GTC_CTRG                       3
SSP_GTC_CTRG_EN                    1
...
# FT X DC X FTOFPCU X PCAL > 10 MeV X CTOF 
VTP_GT_TRGBIT  0   8  63  1  1  1  0 # SSP STRG3, SECTOR 1-6, CTRG0  OK
...
# FTOFxPCUx(PCAL>10MeV)xDC(old-style), Individual Sectors
...
VTP_GT_TRGBIT  13   2   1  1  1  0  0 # SSP STRG1, SECTOR 1
VTP_GT_TRGBIT  14   2   2  1  1  0  0 # SSP STRG1, SECTOR 2
VTP_GT_TRGBIT  15   2   4  1  1  0  0 # SSP STRG1, SECTOR 3
VTP_GT_TRGBIT  16   2   8  1  1  0  0 # SSP STRG1, SECTOR 4
VTP_GT_TRGBIT  17   2  16  1  1  0  0 # SSP STRG1, SECTOR 5
VTP_GT_TRGBIT  18   2  32  1  1  0  0 # SSP STRG1, SECTOR 6

# HTCC, Individual Sectors
#No longer true: This is here just for retro-compatibility
VTP_GT_TRGBIT  19 128   1  1  1  0  0 # SSP STRG7, SECTOR 1
VTP_GT_TRGBIT  20 128   2  1  1  0  0 # SSP STRG7, SECTOR 2
VTP_GT_TRGBIT  21 128   4  1  1  0  0 # SSP STRG7, SECTOR 3
VTP_GT_TRGBIT  22 128   8  1  1  0  0 # SSP STRG7, SECTOR 4
VTP_GT_TRGBIT  23 128  16  1  1  0  0 # SSP STRG7, SECTOR 5
VTP_GT_TRGBIT  24 128  32  1  1  0  0 # SSP STRG7, SECTOR 6

#BIT 25-28 for central delay scans
#CTOF
VTP_GT_TRGBIT  25  16  63  1  1  8  0 # SSP STRG4, SECTOR 1-6, CTRG3
#CND
VTP_GT_TRGBIT  26  32  63  1  1  8  0 # SSP STRG5, SECTOR 1-6, CTRG3
#CTOF * CND
VTP_GT_TRGBIT  27  64  63  1  1  8  0 # SSP STRG6, SECTOR 1-6, CTRG3

#BIT 28: FT(1600-6600)MeV X DC(segments) X FTOFPCU X PCAL>10MeV X CTOF 
VTP_GT_TRGBIT  28   8  63  1  1  1  0 # SSP STRG3, SECTOR 1-6, CTRG0  

#BIT 29: FT(1600-6600)MeV x DC(segments) x FTOFPCU x PCAL>10MeV (1 Sector)     
VTP_GT_TRGBIT  29   2  63  1  1  1  0 # SSP STRG1, SECTOR 1-6, CTRG0

#BIT 30: FT(1600-6600)MeV x DC(segments) x FTOFPCU x PCAL>10MeV x CTOF*CND
VTP_GT_TRGBIT  30   4   63  1  1  1  0 # SSP STRG2, SECTOR 1-6, CTRG0

#BIT 31: FTCal(300-8500MeV)            --> THIS IS THE ONLY TRG SOURCE 
VTP_GT_TRGBIT  31   0   63  1  0  8  0 # SSP CTRG3
