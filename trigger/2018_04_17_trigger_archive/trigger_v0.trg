...
# ECAL cluster trigger logic: EMIN in 0.1MeV units
SSP_GT_STRG_ECAL_CLUSTER_EMIN_EN      1
SSP_GT_STRG_ECAL_CLUSTER_EMIN       300
SSP_GT_STRG_ECAL_CLUSTER_WIDTH       96
...
# HTCC
VTP_GT_TRGBIT  7   1  63  1  1  0  # SSP STRG0, SECTOR 1-6

# PCAL
VTP_GT_TRGBIT  8   2  63  1  1  0  # SSP STRG1, SECTOR 1-6

# ECAL
VTP_GT_TRGBIT  9   4  63  1  1  0  # SSP STRG2, SECTOR 1-6

# HTCC x PCAL (low threshold)
VTP_GT_TRGBIT 10  16  63  1  1  0  

# HTCC x PCAL (high threshold)
VTP_GT_TRGBIT 11  32  63  1  1  0  

# FTOF x PCAL x ECAL
VTP_GT_TRGBIT 12  64  63  1  1  0  

# FTOF  x PCAL
VTP_GT_TRGBIT 13 128  63  1  1  0  

# trigger bit 14  2 out of 6 sectors have FTOF x PCAL x ECAL
VTP_GT_TRGBIT 14  64  63  2  12  0

# trigger bit 15,16,17  2 out of 6 sectors have FTOF x PCAL x ECAL in opposite sectors
VTP_GT_TRGBIT 15  64   9  2  12  0  # SSP STRG6, SECTOR 1 && SECTOR 4
VTP_GT_TRGBIT 16  64  18  2  12  0  # SSP STRG6, SECTOR 2 && SECTOR 5
VTP_GT_TRGBIT 17  64  24  2  12  0  # SSP STRG6, SECTOR 3 && SECTOR 6

# trigger bit 18  2 out of 6 sectors have FTOF x PCAL
VTP_GT_TRGBIT 18 128  63  2  12  0

# trigger bit 19,20,21  2 out of 6 sectors have FTOF x PCAL in opposite sectors
VTP_GT_TRGBIT 19 128   9  2  12  0  # SSP STRG6, SECTOR 1 && SECTOR 4
VTP_GT_TRGBIT 20 128  18  2  12  0  # SSP STRG6, SECTOR 2 && SECTOR 5
VTP_GT_TRGBIT 21 128  24  2  12  0  # SSP STRG6, SECTOR 3 && SECTOR 6
...
# Prescale FTOF*PCAL
TS_GTP_PRESCALE 29 13

#Prescale FT
TS_GTP_PRESCALE 30 12
