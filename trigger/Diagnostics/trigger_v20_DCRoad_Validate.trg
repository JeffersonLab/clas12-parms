...
#
#  (PCAL+ECAL) > 2000MeV x PCAL>200MeV x ECAL>100MeV
########################
SSP_GT_STRG                           5
SSP_GT_STRG_EN                        1
...
# PCAL cluster trigger logic
SSP_GT_STRG_PCAL_CLUSTER_EMIN_EN      1
SSP_GT_STRG_PCAL_CLUSTER_EMIN       2000
SSP_GT_STRG_PCAL_CLUSTER_WIDTH       96

# ECAL cluster trigger logic
SSP_GT_STRG_ECAL_CLUSTER_EMIN_EN      1
SSP_GT_STRG_ECAL_CLUSTER_EMIN       1000
SSP_GT_STRG_ECAL_CLUSTER_WIDTH       96

# PCAL+ECAL cluster trigger logic: EMIN in 0.1MeV units
SSP_GT_STRG_ECALPCAL_CLUSTER_EMIN_EN      1
SSP_GT_STRG_ECALPCAL_CLUSTER_EMIN      20000
SSP_GT_STRG_ECALPCAL_CLUSTER_WIDTH       96
...
#
#    HTCC x DC (6 layers) x FTOFPCU (0 tolerance)
########################
SSP_GT_STRG                           6
SSP_GT_STRG_EN                        1
...
VTP_GT_TRGBIT  7   12   1  1  1  0  # SSP STRG0|STRG1, SECTOR 1
VTP_GT_TRGBIT  8   12   2  1  1  0  # SSP STRG0|STRG1, SECTOR 2
VTP_GT_TRGBIT  9   12   4  1  1  0  # SSP STRG0|STRG1, SECTOR 3
VTP_GT_TRGBIT  10  12   8  1  1  0  # SSP STRG0|STRG1, SECTOR 4
VTP_GT_TRGBIT  11  12   16 1  1  0  # SSP STRG0|STRG1, SECTOR 5
VTP_GT_TRGBIT  12  12   32 1  1  0  # SSP STRG0|STRG1, SECTOR 6

# DC x FTOFPCU x PCAL>15MeV x CTOF, Individual Sectors (for tagging/efficiency studies)
VTP_GT_TRGBIT 13   16   1  1  1  0  0  # SSP STRG2, SECTOR 1
VTP_GT_TRGBIT 14   16   2  1  1  0  0  # SSP STRG2, SECTOR 2
VTP_GT_TRGBIT 15   16   4  1  1  0  0  # SSP STRG2, SECTOR 3
VTP_GT_TRGBIT 16   16   8  1  1  0  0  # SSP STRG2, SECTOR 4
VTP_GT_TRGBIT 17   16  16  1  1  0  0  # SSP STRG2, SECTOR 5
VTP_GT_TRGBIT 18   16  32  1  1  0  0  # SSP STRG2, SECTOR 6

# (PCAL+ECAL) > 2000MeV x PCAL>200MeV x ECAL>100MeV
VTP_GT_TRGBIT 19   32   1  1  1  0  0  # SSP STRG2, SECTOR 1
VTP_GT_TRGBIT 20   32   2  1  1  0  0  # SSP STRG2, SECTOR 2
VTP_GT_TRGBIT 21   32   4  1  1  0  0  # SSP STRG2, SECTOR 3
VTP_GT_TRGBIT 22   32   8  1  1  0  0  # SSP STRG2, SECTOR 4
VTP_GT_TRGBIT 23   32  16  1  1  0  0  # SSP STRG2, SECTOR 5
VTP_GT_TRGBIT 24   32  32  1  1  0  0  # SSP STRG2, SECTOR 6

# HTCC x DC (6 layers) x FTOFPCU (0 tolerance)
VTP_GT_TRGBIT 25   64   1  1  1  0  0  # SSP STRG2, SECTOR 1
VTP_GT_TRGBIT 26   64   2  1  1  0  0  # SSP STRG2, SECTOR 2
VTP_GT_TRGBIT 27   64   4  1  1  0  0  # SSP STRG2, SECTOR 3
VTP_GT_TRGBIT 28   64   8  1  1  0  0  # SSP STRG2, SECTOR 4
VTP_GT_TRGBIT 29   64  16  1  1  0  0  # SSP STRG2, SECTOR 5
VTP_GT_TRGBIT 30   64  32  1  1  0  0  # SSP STRG2, SECTOR 6

# PULSER
VTP_GT_TRG             31
VTP_GT_TRG_PULSER_FREQ 1.0
...
# Other than 13-18, Hope other bit's don't need to be prescaled
